...
export default function ProductDetails()
{
    ...
    const productB = useSelector(store => store.productB);
    ...
    return (
        <div className="bg-white lg:px-20">
            <div className="pt-6">
                    ...
                    <div className="lg:col-span-1 maxt-auto max-w-2xl px-4 pb-16 sm:px-6 lg:max-w-7xl lg:px-8
                        ...
                        <div className="lg:col-span-2 ">
                            <h1 className="text-lg lg:text-xl font-semibold text-gray-900">
                                {/* Brand */}
                                {productB.product?.brand}
                            </h1>
                            <h1 className="text-lg lg:text-xl text-gray-900 opacity-60 pt-1">
                                {/* Title */}
                                {productB.product?.title}
                            </h1>
                        </div>
                        ...
                        <div className="mt-4 lg:row-span-3 lg:mt-0">
                            ...
                            <div className="flex space-x-5 items-center text-lg lg:text-xl text-gray-900 mt-6">
                                <p className="font-semibold">
                                    {/* Discounted Price */}
                                    {productB.product?.discountedPrice}
                                </p>
                                <p className="opacity-50 line-through">
                                    {/* Price */}
                                    {productB.product?.price}
                                </p>
                                <p className="text-green-600 font-semibold">
                                    {/* Discount % */}
                                    {productB.product?.discountPercent + " % off"}
                                </p>
                            </div>
                            ...
                            <div className="mt-6">
                                <div className="flex items-center space-x-3">
                                    ...
                                    <p className="opacity-50 text-sm">534534 Ratings</p>
                                    <p className="ml-3 text-sm font-medium text-indigo-600
                                              hover:text-indigo-500">5345 Reviews</p>
                                </div>
                ...
                <section>
                    <h1 className="font-semibold text-lg pb-4">Rating & Review</h1>
                        ...
                        <Grid container spacing={7}>
                            ...
                            <Grid item xs={5}>
                                ...
                                <div className="flex items-center space-x-3">
                                    ...
                                    <p className="opacity-60">45345 Ratings</p>
                                </div>
